...
In the following, the charter and the courses provided by the Institute of Architecture of Application Systems ([IAAS](http://www.iaas.uni-stuttgart.de/institut/mitarbeiter/indexE.php)) are discussed. The [list of individual courses](#Spectrum) is presented and [several clusters of courses](#Clusters) emphasizing different foci are recommended.
...
An application system directly supports the business activities of an enterprise. Thus, it must satisfy strong requirements in terms of *non-functional properties* like availability, scalability, resiliency, security and performance.

IAAS is concerned with the *architecture* of such enterprise systems, i.e., their underlying structure: What kind of building blocks and connections between them are needed to build such a system and guarantee its non-functional properties? In this context, IAAS is focussed on *middleware*, i.e., what kind of middleware is needed in the componentry of an architure of an application system, and how is such middleware used properly. Other concerns are adequate paradigms to *model* and specify application systems as well as their *compliance* with non-functional properties. 

In order to enable proper support of the various business activities of enterprises, IAAS investigates the role of *business processes* in application systems. Both, proper modelling of business processes as well as middleware needed to support them (so-called *workflow management systems* or *process management systems*) as discussed. Business processes are considered as *programs in the large* and the composition of applications via business processes is investigated in terms of functionality as well as non-functional properties.
...
More and more, services are not only realized by software or human beings, but also by sensors and actuators. Thus, IAAS is also concerned with the *Internet of Things* (IoT) and cyber-physical systems. 
...
After attending these lectures, the major concepts and technologies behind large-scale distributed applications like non-functional properties, loose-coupling, architectural styles, relevant patterns as well as cloud architectural concers and cloud platforms are understood. 
